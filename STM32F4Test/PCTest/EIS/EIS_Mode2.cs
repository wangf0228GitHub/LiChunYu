...
namespace PCTest
{
    public class EIS_Mode2_ReadData
    {
        public CANCommand[] canCommand=new CANCommand[1+1+46*3];
        public EIS_Mode2_ReadData()
        {
            ...
            for (int i = 0; i < 46; i++)
            {
                ...
                canCommand[2 + i * 3].TxData = new byte[] { 0x06, 0x31, 0x01, 0x03, 0x22, 0x6F, 0x00, 0xFF };
                //命令字
                canCommand[2 + i * 3].TxData[6] = (byte)(i);
                ...
                canCommand[2 + i * 3 + 1].TxData = new byte[] { 0x06, 0x31, 0x01, 0x03, 0x22, 0x6F, 0x00, 0xFF };
                //命令字
                canCommand[2 + i * 3 + 1].TxData[6] =(byte)(i);
                ...
                canCommand[2 + i * 3 + 2].NeedRxPocket = 2;
            }
        }
    }
}
