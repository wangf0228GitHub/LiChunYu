...
# 1 "../../../WF_Device/CP1616_Client.c"

# 18 "C:/Users/Administrator/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.9.163/xc8\pic\include\xc.h"
extern const char __xc8_OPTIM_SPEED;

extern double __fpnormalize(double);


# 13 "D:\Program Files\Microchip\xc8\v2.32\pic\include\c90\xc8debug.h"
#pragma intrinsic(__builtin_software_breakpoint)
extern void __builtin_software_breakpoint(void);

# 13 "D:\Program Files\Microchip\xc8\v2.32\pic\include\c90\stdint.h"
...
# 7 "C:/Users/Administrator/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.9.163/xc8\pic\include\builtins.h"
...
# 109 "C:/Users/Administrator/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.9.163/xc8\pic\include\proc\pic16f15344.h"
...
# 76 "C:/Users/Administrator/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.9.163/xc8\pic\include\pic.h"
...
# 15 "D:\Program Files\Microchip\xc8\v2.32\pic\include\c90\stdbool.h"
typedef unsigned char bool;

# 29 "D:\Program Files\Microchip\xc8\v2.32\pic\include\c90\errno.h"
extern int errno;

# 12 "D:\Program Files\Microchip\xc8\v2.32\pic\include\c90\conio.h"
...
# 15 "../../../WF_Device\Verify.h"
uint8_t GetVerify_Sum(uint8_t* pBuff,uint8_t Count);

# 16 "../../../WF_Device/CP1616_Client.h"
typedef union
{
struct
{
...
# 60
extern volatile uint8_t CP1616_Client_RxList[20];
...
# 24
volatile uint8_t CP1616_Client_RxList[20];
void CP1616_Client_Init(void)
{
;
...
if(CP1616_Client_RxCount>2u+1+1u+1)
{
if(rx==0x0d && CP1616_Client_RxCount==CP1616_Client_NeedRxCount)
{

sum=GetVerify_Sum((uint8_t*)CP1616_Client_RxList,CP1616_Client_NeedRxCount-2u);
...
else if(CP1616_Client_RxCount>20)
{
CP1616_Client_RxCount=0;
...
else if(CP1616_Client_RxCount==2u+1+1u+1)
{

CP1616_Client_NeedRxCount=CP1616_Client_RxList[2u+1+1u+1-1u]+2u+1+1u+1+2u;

# 93
if(CP1616_Client_NeedRxCount>20)
CP1616_Client_RxCount=0;
}

else if(CP1616_Client_RxCount==3)
{

if(CP1616_Client_RxList[2]!=CP1616_Client_Addr)
{
if(CP1616_Client_RxList[2]!=0xff)
{
CP1616_Client_RxCount=0;
}
}
...
EUSART1_Write(0x16);sum=(unsigned char)(sum+0x16);
EUSART1_Write(0x16);sum=(unsigned char)(sum+0x16);

EUSART1_Write(CP1616_Client_Addr);sum=(unsigned char)(sum+CP1616_Client_Addr);

# 155
EUSART1_Write(CommandIndex);sum=(unsigned char)(sum+CommandIndex);


EUSART1_Write(Count);sum=(unsigned char)(sum+Count);

# 163
EUSART1_Write(0x01);sum=(unsigned char)(sum+0x01);
for(i=0;i<(Count-1);i++)
{
EUSART1_Write(pBuff[i]);sum=(unsigned char)(sum+pBuff[i]);
}
EUSART1_Write(sum);
EUSART1_Write(0x0d);
...
# 320
EUSART1_Write(errNum);sum=(unsigned char)(sum+errNum);
EUSART1_Write(sum);
EUSART1_Write(0x0d);
