...
uint8_t i=0;
SYSTEM_Initialize();
flash = FLASH_ReadWord(0x0fe0);
if (flash != 0x1234)
{
FLASH_WriteWord(0x0fe0, flashBlock, 0x1234);
FLASH_WriteWord(0x0fe0+4, flashBlock, 0x3030);
}
flash=FLASH_ReadWord(0x0fe0 + 4);
