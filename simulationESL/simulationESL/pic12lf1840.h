#ifndef	_HTC_H_
#warning Header file pic12lf1840.h included directly. Use #include <htc.h> instead.
#endif
...
#ifndef __PIC12LF1840_H
#define __PIC12LF1840_H
...
// bit and bitfield definitions
// volatile bit MDCL0               @ ((unsigned)&MDCARH*8)+0;
// volatile bit MDCL1               @ ((unsigned)&MDCARH*8)+1;
// volatile bit MDCL2               @ ((unsigned)&MDCARH*8)+2;
// volatile bit MDCL3               @ ((unsigned)&MDCARH*8)+3;
// volatile bit MDCLSYNC            @ ((unsigned)&MDCARH*8)+5;
// volatile bit MDCLPOL             @ ((unsigned)&MDCARH*8)+6;
// volatile bit MDCLODIS            @ ((unsigned)&MDCARH*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	MDCL0               : 1;
