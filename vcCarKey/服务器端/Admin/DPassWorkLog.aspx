<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DPassWorkLog.aspx.cs" Inherits="服务器端.Admin.DPassWorkLog" %>
            ...
            <tr>
                ...
                <td valign="top" background="./Images/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="././Images/content_bg.gif">
                        <tr><td height="31"><div class="title">DPass查询日志</div></td></tr>
                    </table>
                </td>
                            ...
                            <td colspan="3">
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="eTime" HeaderText="时间" />
