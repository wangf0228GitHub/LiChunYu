...
{
    public partial class ESLWorkLog : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //保存当前查询状态
                DataTable tb = ESLWorkLogDataDBOption.DataTableSelect_addrownum();
                BindDisplayList();
            }
        }
        ...
        private void BindDisplayList(int pageIndex)
        {
            ...
            if (HiddenField2.Value == "0")
                tb = ESLWorkLogDataDBOption.DataTableSelect_addrownum();
            else if (HiddenField2.Value == "1")
                tb = ESLWorkLogDataDBOption.DataTableSelect_byID(TextBox1.Text);
            else
                tb = ESLWorkLogDataDBOption.DataTableSelect_byID(DropDownList1.Text);
