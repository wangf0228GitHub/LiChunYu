...
float CCarKey3App::m_fSoftVer=10.01f;

CString CCarKey3App::RunPath;
CWithServer CCarKey3App::withServer;
#ifdef _UseCopy
CHIDDevice CCarKey3App::TheHIDDevice;
#else
