...
// 	ON_BN_CLICKED(IDC_BUTTON3, &CCarKey3Dlg::OnBnESL)
	...
	ON_STN_CLICKED(IDC_STATIC123, &CCarKey3Dlg::OnStnClickedStatic123)
END_MESSAGE_MAP()
...
// 		GetWindowRect(&rc);  
// 		CImage mImage;
// 		if(CCommFunc::ImageFromIDResource(&mImage,IDB_PNG1,_T("PNG")))  
// 		{  
// 			//这里让图片绘制区域和窗口大小一致  
...
void CCarKey3Dlg::OnStnClickedStatic123()
{
	// TODO: 在此添加控件通知处理程序代码
}
