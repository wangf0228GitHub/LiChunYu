...
//         public int UsedTimes;
        ...
        public void SetVerifyData_SoftVersion()
        {
            ...
            strDes = des.EncryptString((0.01f).ToString("f2"), sKey, sIV_SoftVerion);
        ...
        public void GetVerifyData()
        {
            ...
            catch (FileNotFoundException)
            {
                ...
                fs.Close();
                File.SetAttributes("Runinfo.mkt", FileAttributes.System | FileAttributes.Hidden);
                BINUpdateTime = DateTime.Now.AddDays(-52);
                SoftUpdateTime = DateTime.Now.AddDays(-52);
                LicUpdateTime = DateTime.Now.AddDays(-52);
                SoftVersion = 0.01f;//车钥匙.HIDDevice.SoftVersion;
                SetVerifyData_SoftVersion();
                SetVerifyData_BINUpdateTime(DateTime.Now.AddDays(-52));
                SetVerifyData_LicUpdateTime(DateTime.Now.AddDays(-52));
                SetVerifyData_SoftUpdateTime(DateTime.Now.AddDays(-52));
            }
            catch
            {
                throw;
